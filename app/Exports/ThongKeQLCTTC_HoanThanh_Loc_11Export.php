...
class ThongKeQLCTTC_HoanThanh_Loc_11Export implements FromQuery, WithHeadings, ShouldAutoSize
{
  /**
  ...
  public function __construct(int $ma_l, int $ma_k)
  {
    $this->ma_l = $ma_l;
    $this->ma_k = $ma_k;
    return $this;
