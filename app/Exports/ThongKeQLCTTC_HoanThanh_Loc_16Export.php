...
class ThongKeQLCTTC_HoanThanh_Loc_16Export implements FromQuery, WithHeadings, ShouldAutoSize
{
  /**
  ...
  public function __construct(string $batdau_venuoc, string $ketthuc_venuoc, int $ma_qg)
  {
