...
class ThongKeQLKTKL_kl_allExport implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  use Exportable;
  public function __construct(int $ma_lkl, int $ma_k, string $batdau_kl,  string $ketthuc_kl)
  {
    $this->ma_lkl = $ma_lkl;
    $this->ma_k = $ma_k;
