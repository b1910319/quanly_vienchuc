...
class ThongKeQLCTTC_ThoiHoc_Loc_7Export implements FromQuery, WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  public function __construct(string $batdau_thoihoc, string $ketthuc_thoihoc)
  {
