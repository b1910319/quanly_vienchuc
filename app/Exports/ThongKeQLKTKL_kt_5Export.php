...
class ThongKeQLKTKL_kt_5Export implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
  ...
  public function __construct(int $ma_htkt, string $batdau_kt, string $ketthuc_kt)
  {
