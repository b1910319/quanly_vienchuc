...
class ThongKeQLCTTC_GiaHan_Loc_11Export implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  public function __construct(string $batdau_giahan, string $ketthuc_giahan, int $ma_qg)
  {
