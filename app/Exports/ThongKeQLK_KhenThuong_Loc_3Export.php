...
class ThongKeQLK_KhenThuong_Loc_3Export implements FromQuery, WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  public function __construct(int $ma_k, int $ma_lkt, string $batdau_kt, string $ketthuc_kt)
  {
    $this->ma_k = $ma_k;
    $this->ma_lkt = $ma_lkt;
