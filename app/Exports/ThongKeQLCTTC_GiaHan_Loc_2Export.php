...
class ThongKeQLCTTC_GiaHan_Loc_2Export implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  public function __construct(int $ma_l, string $batdau_giahan, string $ketthuc_giahan)
  {
    $this->ma_l = $ma_l;
