...
class ThongKeQLCTTC_HoanThanh_Loc_6Export implements FromQuery, WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  public function __construct(string $batdau_capbang, string $ketthuc_capbang)
  {
