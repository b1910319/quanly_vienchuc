...
class ThongKeQLKTKL_kt_15Export implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  use Exportable;
  public function __construct(int $ma_htkt, int $ma_k, string $batdau_kt, string $ketthuc_kt)
  {
    $this->ma_k = $ma_k;
