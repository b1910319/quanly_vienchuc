...
class ThongKeQLCTTC_HoanThanh_Loc_3Export implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  public function __construct(int $ma_l, string $batdau_venuoc, string $ketthuc_venuoc  )
  {
    $this->ma_l = $ma_l;
