...
class ThongKeQLKTKL_kt_2Export implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
  ...
  public function __construct(int $ma_lkt, int $ma_htkt, string $batdau_kt, string $ketthuc_kt)
  {
    $this->ma_lkt = $ma_lkt;
