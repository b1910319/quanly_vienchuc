...
class ThongKeQLCTTC_GiaHan_Loc_AllExport implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  public function __construct(int $ma_k, int $ma_l, string $batdau_giahan, string $ketthuc_giahan)
  {
    $this->ma_k = $ma_k;
    $this->ma_l = $ma_l;
