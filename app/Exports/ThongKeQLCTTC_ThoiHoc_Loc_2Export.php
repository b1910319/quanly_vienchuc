...
class ThongKeQLCTTC_ThoiHoc_Loc_2Export implements FromQuery, WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  public function __construct(int $ma_l, string $batdau_thoihoc, string $ketthuc_thoihoc)
  {
    $this->ma_l = $ma_l;
