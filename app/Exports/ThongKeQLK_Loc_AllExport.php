...
class ThongKeQLK_Loc_AllExport implements FromQuery, WithHeadings, ShouldAutoSize
{
  /**
  ...
  public function query()
  {
    ...
    ->select('vienchuc.ma_vc', 'vienchuc.hoten_vc', 'vienchuc.user_vc', 'vienchuc.sdt_vc', 'vienchuc.ngaysinh_vc', 'khoa.ten_k', 'chucvu.ten_cv', 'dantoc.ten_dt', 'tongiao.ten_tg', 'ngach.ten_n', 'hedaotao.ten_hdt', 'loaibangcap.ten_lbc', 'tinh.ten_t', 'thuongbinh.ten_tb');
  }
}
