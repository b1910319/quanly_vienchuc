...
class ThongKeQLCTTC_HoanThanh_Loc_15Export implements FromQuery, WithHeadings, ShouldAutoSize
{
  /**
  ...
  public function __construct(string $batdau_venuoc, string $ketthuc_venuoc, int $ma_k)
  {
