...
class ThongKeQLCTTC_DungHoc_Loc_3Export implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  public function __construct(int $ma_k, string $batdau_dunghoc, string $ketthuc_dunghoc)
  {
    $this->ma_k = $ma_k;
