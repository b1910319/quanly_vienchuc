...
class ThongKeQLKTKL_kl_3Export implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  use Exportable;
  public function __construct(int $ma_lkl, string $batdau_kl,  string $ketthuc_kl)
  {
    $this->ma_lkl = $ma_lkl;
