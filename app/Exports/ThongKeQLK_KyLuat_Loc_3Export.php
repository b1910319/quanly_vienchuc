...
class ThongKeQLK_KyLuat_Loc_3Export implements FromQuery, WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  public function __construct(int $ma_k, string $batdau_kl, string $ketthuc_kl)
  {
    $this->ma_k = $ma_k;
