...
class ThongKeQLTT_nghi_allExport implements FromQuery, WithHeadings, ShouldAutoSize
{
  /**
  ...
  public function __construct(int $ma_dmn, int $ma_k, string $batdau, string $ketthuc)
  {
    $this->ma_dmn = $ma_dmn;
    $this->ma_k = $ma_k;
    $this->batdau = $batdau;
  ...
  public function query()
  {
    ...
    ->where('danhmucnghi.ma_dmn', $this->ma_dmn)
