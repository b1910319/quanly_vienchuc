...
class ThongKeQLKTKL_kt_3Export implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
  ...
  public function __construct(int $ma_lkt, int $ma_k, string $batdau_kt, string $ketthuc_kt)
  {
    $this->ma_lkt = $ma_lkt;
    $this->ma_k = $ma_k;
