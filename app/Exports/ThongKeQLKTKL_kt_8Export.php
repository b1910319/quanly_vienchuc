...
class ThongKeQLKTKL_kt_8Export implements FromQuery,WithHeadings, ShouldAutoSize
{
  /**
   * @return \Illuminate\Support\Collection
   */
  use Exportable;
  public function __construct(int $ma_lkt, string $batdau_kt, string $ketthuc_kt)
  {
    $this->ma_lkt = $ma_lkt;
