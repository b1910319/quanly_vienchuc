...
class NghiHuuController extends Controller
{
  ...
  public function nghihuu(){
    ...
    if($phanquyen_admin || $phanquyen_qltt){
      ...
      $ketthuc_nam = Carbon::parse(Carbon::now()->subYears(61))->format('Y-m-d');
      $batdau_nam = Carbon::parse(Carbon::now()->subYears(62))->format('Y-m-d');
      // $ketthuc_nam = Carbon::now()->subYears(); //61 nam 11 thang
      $ketthuc_nu = Carbon::parse(Carbon::now()->subYears(59))->format('Y-m-d');
      $batdau_nu = Carbon::parse(Carbon::now()->subYears(60))->format('Y-m-d');
