...
class ThongKeController extends Controller
{
  ...
  public function thongke_qltt_nghi_loc(Request $request){
    ...
    if ($phanquyen_admin || $phanquyen_qltt) {
      ...
      if (isset($data['ma_dmn']) && isset($data['ma_k']) &&  isset($data['batdau'])  && isset($data['ketthuc'])) {
        ...
        $count_nghi_6 = VienChuc::join('khoa', 'khoa.ma_k', '=', 'vienchuc.ma_k')
          ->join('quatrinhnghi', 'quatrinhnghi.ma_vc', '=', 'vienchuc.ma_vc')
          ->join('danhmucnghi', 'danhmucnghi.ma_dmn', '=', 'quatrinhnghi.ma_dmn')
          ->select(DB::raw('count(quatrinhnghi.ma_vc) as sum, khoa.ma_k'))
          ->groupBy('khoa.ma_k')
          ->get();
        $list_nghi_6 = VienChuc::join('khoa', 'khoa.ma_k', '=', 'vienchuc.ma_k')
          ->join('quatrinhnghi', 'quatrinhnghi.ma_vc', '=', 'vienchuc.ma_vc')
          ->join('danhmucnghi', 'danhmucnghi.ma_dmn', '=', 'quatrinhnghi.ma_dmn')
          ->where('vienchuc.ma_k', $data['ma_k'])
          ->get();
        ...
        $count_nghi_7 = VienChuc::join('khoa', 'khoa.ma_k', '=', 'vienchuc.ma_k')
          ->join('quatrinhnghi', 'quatrinhnghi.ma_vc', '=', 'vienchuc.ma_vc')
          ->join('danhmucnghi', 'danhmucnghi.ma_dmn', '=', 'quatrinhnghi.ma_dmn')
          ->select(DB::raw('count(quatrinhnghi.ma_vc) as sum, quatrinhnghi.batdau_qtn'))
          ->groupBy('quatrinhnghi.batdau_qtn')
          ->get();
        $list_nghi_7 = VienChuc::join('khoa', 'khoa.ma_k', '=', 'vienchuc.ma_k')
          ->join('quatrinhnghi', 'quatrinhnghi.ma_vc', '=', 'vienchuc.ma_vc')
          ->join('danhmucnghi', 'danhmucnghi.ma_dmn', '=', 'quatrinhnghi.ma_dmn')
          ->whereBetween('quatrinhnghi.batdau_qtn', [$data['batdau'], $data['ketthuc']])
          ->get();
  ...
  public function thongke_qltt_loc_nghi_6_pdf( $ma_k){
    $this->check_login();
    $ma_vc = session()->get('ma_vc');
    $phanquyen_admin = PhanQuyen::where('ma_vc', $ma_vc)
      ->where('ma_q', '=', '5')
  ...
  public function thongke_qltt_loc_nghi_6_excel( $ma_k){
    $this->check_login();
    $ma_vc = session()->get('ma_vc');
    $phanquyen_admin = PhanQuyen::where('ma_vc', $ma_vc)
      ->where('ma_q', '=', '5')
    ...
    $phanquyen_qltt = PhanQuyen::where('ma_vc', $ma_vc)
      ...
      ->first();
    if ($phanquyen_admin || $phanquyen_qltt) {
      return (new ThongKeQLTT_nghi_6Export( $ma_k))->download('Danh-sach-vien-chuc.xlsx');
    } else {
      return Redirect::to('/home');
    }
  }

  public function thongke_qltt_loc_nghi_7_pdf(  $batdau, $ketthuc){
    $this->check_login();
    $ma_vc = session()->get('ma_vc');
    $phanquyen_admin = PhanQuyen::where('ma_vc', $ma_vc)
      ->where('ma_q', '=', '5')
  ...
  public function thongke_qltt_loc_nghi_7_excel(  $batdau, $ketthuc){
    $this->check_login();
    $ma_vc = session()->get('ma_vc');
    $phanquyen_admin = PhanQuyen::where('ma_vc', $ma_vc)
      ->where('ma_q', '=', '5')
    ...
    $phanquyen_qltt = PhanQuyen::where('ma_vc', $ma_vc)
      ...
      ->first();
    if ($phanquyen_admin || $phanquyen_qltt) {
      return (new ThongKeQLTT_nghi_7Export(  $batdau, $ketthuc))->download('Danh-sach-vien-chuc.xlsx');
    } else {
      return Redirect::to('/home');
    }
  }
