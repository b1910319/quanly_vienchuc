...
class ThongKeController extends Controller
{
  ...
  //       ->with('count_nghihuu_loc', $count_nghihuu_loc)
  ...
  //       ->get();
  //     $list = VienChuc::join('khoa', 'khoa.ma_k', '=', 'vienchuc.ma_k')
  //       ->join('chucvu', 'vienchuc.ma_cv', '=', 'chucvu.ma_cv')
  //       ->where('thoigiannghi_vc', '<>', ' ')
  //       ->where('status_vc', '2')
  //       ->get();
  //     return view('thongke.thongke_qltt')
  ...
  //     $count_lbc = '';
  //     $count_ngach_ma_n = '';
  //     $count_nghihuu_loc = VienChuc::join('khoa', 'khoa.ma_k', '=', 'vienchuc.ma_k')
  //       ->where('thoigiannghi_vc', '<>', ' ')
  //       ->where('status_vc', '2')
