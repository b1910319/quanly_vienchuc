...
<div class="row">
  <div class="card-box">
    ...
    <?php 
      $mess = session()->get('message_add_chauluc');
      if ($mess != null) {
        ?>
        ...
        <?php
        $mess = session()->put('message_add_chauluc', null);
      }
    ?>
    <?php 
      $mess = session()->get('message_update_chauluc');
      if ($mess != null) {
        ?>
        ...
        <?php
        $mess = session()->put('message_update_chauluc', null);
      }
    ?>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form class="form-container" action="{{ URL::to('add_chauluc_excel') }}" method="POST" enctype='multipart/form-data'>
                    @csrf
                    <div class="row">
                      <div class="col-9">
                        <div class="mb-3">
      ...
      <table class="table" id="mytable">
        <thead class="color_table">
          <tr>
            ...
            <th class="text-light" scope="col">Châu lục</th>
          ...
          @foreach ($list as $key => $chauluc)
            <tr >
              ...
              <td style="width: 27%;">
                ...
                <button type="button" class=" xoa{{ $chauluc->ma_cl }} btn btn-danger button_do"><i class="fa-solid fa-trash text-light"></i> &ensp;Xoá</button>
                <?php
                  if($chauluc->status_cl == 0){
                    ?>
