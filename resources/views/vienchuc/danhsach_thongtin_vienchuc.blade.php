...
<div class="row">
  <div class="card-box col-2">
    <div class="row">
      ...
      <div class="dropdown mt-2" >
        <button class="dropbtn button_loc_left " style="width: 100%;">Khoa</button>
      ...
      <div class="dropdown mt-2" >
        <button class="dropbtn button_loc_left" style="width: 100%;">Dân tộc</button>
        <div class="dropdown-content">
      ...
      <div class="dropdown mt-2" >
        <button class="dropbtn button_loc_left" style="width: 100%;">Tôn giáo</button>
        <div class="dropdown-content">
      ...
      <div class="dropdown mt-2" >
        <button class="dropbtn button_loc_left" style="width: 100%;">Giới tính</button>
        <div class="dropdown-content">
      ...
      <div class="dropdown mt-2" >
        <button class="dropbtn button_loc_left" style="width: 100%;">Thương binh</button>
        <div class="dropdown-content">
      ...
      <div class="dropdown mt-2" >
        <button class="dropbtn button_loc_left" style="width: 100%;">Hệ đào tạo</button>
        <div class="dropdown-content">
      ...
      <div class="dropdown mt-2" >
        <button class="dropbtn button_loc_left" style="width: 100%;">Loại bằng cấp</button>
        <div class="dropdown-content">
  ...
  <div class="card-box col-10">
    ...
    <div class="row">
      <div class="col-3">
        <button type="button" class="btn btn-info button_loc" data-toggle="collapse" data-target="#demo1" style="width: 100%">
      ...
      <div class="col-3">
        <button type="button" class="btn btn-info button_loc" data-toggle="collapse" data-target="#demo" style="width: 100%">
          <i class="fa-solid fa-filter text-light"></i>
          &ensp;
          Tìm theo ngày sinh
        </button>
      ...
      <div class="col-3">
        <button type="button" class="btn btn-info button_loc" data-toggle="collapse" data-target="#demo2" style="width: 100%" >
          <i class="fa-solid fa-filter text-light"></i>
          &ensp;
          Tìm theo ngạch
        </button>
      ...
      <div class="col-3 mb-2">
        <button type="button" class="btn btn-info button_loc" data-toggle="collapse" data-target="#demo3" style="width: 100%">
          <i class="fa-solid fa-filter text-light"></i>
          &ensp;
