          ...
          @foreach ($list as $key => $thoihoc)
            <tr >
              ...
              <td style="width: 21%;">
                ...
                <button type="button" class=" xoa{{ $thoihoc->ma_th }} btn btn-danger fw-bold" style="background-color: #FF1E1E"><i class="fa-solid fa-trash"></i> &ensp;Xoá</button>
                <?php
                  if($thoihoc->status_th == 0){
                    ?>
