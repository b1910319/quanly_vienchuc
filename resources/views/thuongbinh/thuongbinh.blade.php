                    ...
                    <table class="table">
                      <tbody>
                        <tr>
                          ...
                          <td class="was-validated">
                            <textarea class="form-control" rows="4" required name="mota_tb">
          ...
          @foreach ($list as $key => $thuongbinh)
            <tr >
              ...
              <td style="width: 21%;">
                ...
                <button type="button" class=" xoa{{ $thuongbinh->ma_tb }} btn btn-danger fw-bold" style="background-color: #FF1E1E"><i class="fa-solid fa-trash"></i> &ensp;Xoá</button>
                <?php
                  if($thuongbinh->status_tb == 0){
                    ?>
