                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="was-validated">
                            <input type='text' class='form-control input_table' autofocus required name="ten_lkt">
                          </td>
                        </tr>
                      </tbody>
                    </table>
      ...
      <tbody  >
        @foreach ($list as $key => $loaikhenthuong)
          <tr >
            ...
            <td>
              {{ $loaikhenthuong->created_lkt }}
            </td>
            <td>
              {{ $loaikhenthuong->updated_lkt }}
            </td>
            <td style="width: 21%;">
              ...
              <a  onclick="return confirm('Bạn có muốn xóa danh mục không?')" href="{{ URL::to('/delete_loaikhenthuong/'.$loaikhenthuong->ma_lkt)}}">
