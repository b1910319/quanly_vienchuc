...
<div class="row">
  <div class="card-box">
    ...
    <?php 
      $mess = session()->get('message_add_tongiao');
      if ($mess != null) {
        ?>
        ...
        <?php
        $mess = session()->put('message_add_tongiao', null);
      }
    ?>
    <?php 
      $mess = session()->get('message_update_tongiao');
      if ($mess != null) {
        ?>
        ...
        <?php
        $mess = session()->put('message_update_tongiao', null);
      }
    ?>
