...
<div class="row">
  <div class="card-box">
    ...
    <div class="faqs-page block mb-3 ">
      <div class="panel-group" id="accordion2" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default">
          <button role="button" class="item-question collapsed btn btn-primary" data-toggle="collapse" href="#collapse1a1" aria-expanded="false" aria-controls="collapse1a1" style="background-color: #850000; border: none;">
            <i class="fa-solid fa-user"></i> &ensp; Viên chức nghĩ hưu vào hôm nay
          </button>
          <div id="collapse1a1" class="panel-collapse collapse" role="tabpanel">
            <div class="panel-body mt-3">
