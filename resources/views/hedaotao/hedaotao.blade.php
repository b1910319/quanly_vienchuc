                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="was-validated">
                            <input type='text' class='form-control input_table' autofocus required name="ten_hdt">
                          </td>
                        </tr>
                      </tbody>
                    </table>
          ...
          @foreach ($list as $key => $hedaotao)
            <tr >
              ...
              <td style="width: 21%;">
                ...
                <button type="button" class=" xoa{{ $hedaotao->ma_hdt }} btn btn-danger fw-bold" style="background-color: #FF1E1E"><i class="fa-solid fa-trash"></i> &ensp;Xoá</button>
                <?php
                  if($hedaotao->status_hdt == 0){
                    ?>
