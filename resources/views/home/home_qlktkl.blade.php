      ...
      <div class="float-left" dir="ltr">
        @foreach ($count_vienchuc as $vc )
          @foreach ($count_vienchuc_kyluat as $vckl )
            <input data-plugin="knob" data-width="70" data-height="70" data-fgcolor="#1abc9c" data-bgcolor="#d1f2eb" value="<?php echo ceil(($vckl->sum*100)/($vc->sum)) ?>" data-skin="true" data-angleoffset="0" data-readonly="true" data-thickness=".15">
          @endforeach
        @endforeach
      </div>
    ...
    <div class="card-box">
      <div class="float-left" dir="ltr">
        @foreach ($count_vienchuc as $vc )
          ...
          <input data-plugin="knob" data-width="70" data-height="70" data-fgcolor="#3bafda" data-bgcolor="#d8eff8" value="<?php echo ceil(($vckt->sum*100)/($vc->sum)) ?>" data-skin="true" data-angleoffset="0" data-readonly="true" data-thickness=".15">
          @endforeach
        @endforeach
      </div>
      <div class="text-right">
