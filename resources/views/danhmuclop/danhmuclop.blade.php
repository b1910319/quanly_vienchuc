        ...
        <div class="panel panel-default">
          ...
          <div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
            ...
            <div class="offcanvas-body">
              <table class="table-dark text-light" >
                <thead>
                  <tr>
                    <th scope="col">Tên</th>
          ...
          @foreach ($list as $key => $danhmuclop)
            <tr >
              ...
              <td style="width: 22%;">
                ...
                <button type="button" class=" xoa{{ $danhmuclop->ma_dml }} btn btn-danger fw-bold" style="background-color: #FF1E1E"><i class="fa-solid fa-trash"></i> &ensp;Xoá</button>
                <?php
                  if($danhmuclop->status_dml == 0){
                    ?>
