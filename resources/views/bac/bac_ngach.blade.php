                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="was-validated">
                            ...
                            <input id="ten_b" type='text' class='form-control input_table' autofocus required name="ten_b">
      ...
      <table class="table" id="mytable">
        <thead class="color_table">
          <tr>
            ...
            <th class="text-light" scope="col">Tên bậc </th>
