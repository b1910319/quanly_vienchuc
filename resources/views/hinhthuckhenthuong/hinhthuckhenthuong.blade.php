          ...
          @foreach ($list as $key => $hinhthuckhenthuong)
            <tr >
              ...
              <td style="width: 21%;">
                ...
                {{-- <a  onclick="return confirm('Bạn có muốn xóa danh mục không?')" href="{{ URL::to('/delete_hinhthuckhenthuong/'.$hinhthuckhenthuong->ma_htkt)}}">
                ...
                <input class="ma_htkt{{ $hinhthuckhenthuong->ma_htkt }}" type="hidden" value="{{ $hinhthuckhenthuong->ma_htkt }}">
                  <button type="button" class=" xoa{{ $hinhthuckhenthuong->ma_htkt }} btn btn-danger fw-bold" style="background-color: #FF1E1E"><i class="fa-solid fa-trash"></i> &ensp;Xoá</button>
                <?php
                  if($hinhthuckhenthuong->status_htkt == 0){
                    ?>
