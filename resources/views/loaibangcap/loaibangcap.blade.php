      ...
      <tbody  >
        @foreach ($list as $key => $loaibangcap)
          <tr >
            ...
            <td>
              {{ $loaibangcap->created_lbc }}
            </td>
            <td>
              {{ $loaibangcap->updated_lbc }}
            </td>
            <td style="width: 21%;">
              ...
              <a  onclick="return confirm('Bạn có muốn xóa danh mục không?')" href="{{ URL::to('/delete_loaibangcap/'.$loaibangcap->ma_lbc)}}">
