  ...
  <div class="card-box col-12">
    ...
    @if (isset($list_pdf_thuongbinh) )
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlk_loc_thuongbinh_excel/'.$ma_tb) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_nghihuu_time) )
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlk_loc_nghihuu_time_excel/'.$batdau.'/'.$ketthuc) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_kt_all))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlk_kt_loc_all_excel/'.$ma_lkt.'/'.$ma_htkt.'/'.$batdau_kt.'/'.$ketthuc_kt) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_kt_2))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlk_kt_loc_2_excel/'.$ma_htkt.'/'.$batdau_kt.'/'.$ketthuc_kt) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_kt_4))
      <div class="alert alert-light color_alert" role="alert">
        ________THÔNG TIN KHEN THƯỞNG CỦA VIÊN CHỨC LỌC THEO LOẠI KHEN THƯỞNG & HÌNH THỨC KHEN THƯỞNG________
      </div>
      <p style="font-weight: bold; color: #D36B00; font-size: 18px">
        Danh sách được lọc theo: 
        @foreach ($list_loaikhenthuong as $loaikhenthuong )
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlk_kt_loc_4_excel/'.$ma_lkt.'/'.$ma_htkt) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_kt_5))
      <div class="alert alert-light color_alert" role="alert">
        ________THÔNG TIN KHEN THƯỞNG CỦA VIÊN CHỨC LỌC THEO LOẠI KHEN THƯỞNG________
      </div>
      <p style="font-weight: bold; color: #D36B00; font-size: 18px">
        Danh sách được lọc theo: 
        @foreach ($list_loaikhenthuong as $loaikhenthuong )
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlk_kt_loc_5_excel/'.$ma_lkt) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_kt_7))
      <div class="alert alert-light color_alert" role="alert">
        ________THÔNG TIN KHEN THƯỞNG CỦA VIÊN CHỨC LỌC THEO THỜI GIAN________
      </div>
      <p style="font-weight: bold; color: #D36B00; font-size: 18px">
        Danh sách được lọc theo: 
        <span class="badge text-bg-danger">{{ $batdau_kt }}</span>
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlk_kt_loc_7_excel/'.$batdau_kt.'/'.$ketthuc_kt) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_kl_all))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlk_kl_loc_all_excel/'.$ma_lkl.'/'.$batdau_kl.'/'.$ketthuc_kl) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_kl_2))
      <div class="alert alert-light color_alert" role="alert">
        ________THÔNG TIN KỶ LUẬT CỦA VIÊN CHỨC LỌC THEO LOẠI KỶ LUẬT________
      </div>
      <p style="font-weight: bold; color: #D36B00; font-size: 18px">
        Danh sách được lọc theo: 
        @foreach ($list_loaikyluat as $loaikyluat )
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlk_kl_loc_2_excel/'.$ma_lkl) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_kl_3))
      <div class="alert alert-light color_alert" role="alert">
        ________THÔNG TIN KỶ LUẬT CỦA VIÊN CHỨC LỌC THEO THỜI GIAN________
      </div>
      <p style="font-weight: bold; color: #D36B00; font-size: 18px">
        Danh sách được lọc theo: 
        <span class="badge text-bg-danger">{{ $batdau_kl }}</span>
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlk_kl_loc_3_excel/'.$batdau_kl.'/'.$ketthuc_kl) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
