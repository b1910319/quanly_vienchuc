  ...
  <div class="card-box col-12">
              ...
              <form action="{{ URL::to('thongke_qlcttc_hoanthanh_loc') }}" method="post">
                ...
                <div class="modal-body">
                  ...
                  <div class="row mt-2">
                    ...
                    <div class="col-4">
                      <span style="font-weight: bold; font-size: 20px;">Quốc gia</span>
                      <div class="mt-1">
                        <select class="custom-select input_table"  name="ma_qg">
              ...
              <form action="{{ URL::to('thongke_qlcttc_dunghoc_loc') }}" method="post">
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-8">
                      <span style="font-weight: bold; font-size: 20px;">Thời gian tạm dừng</span>
                      <div class="row">
                        <div class="col-6 mt-1">
    ...
    @if (isset($list_hoanthanh_6))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_6_excel/'.$batdau_capbang.'/'.$ketthuc_capbang) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_hoanthanh_7))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_7_excel/'.$batdau_venuoc.'/'.$ketthuc_venuoc) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_hoanthanh_8))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_hoanthanh_8 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_8_pdf/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_8_excel/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_hoanthanh_9))
      ...
      <p style="font-weight: bold; color: #D36B00; font-size: 18px">
        ...
        @foreach ($list_quocgia as $quocgia )
          ...
          <span class="badge text-bg-primary">{{ $quocgia->ten_qg }}</span>
          @endif
        @endforeach
      </p>
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_hoanthanh_9 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_9_pdf/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_9_excel/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_hoanthanh_11))
      ...
      <p style="font-weight: bold; color: #D36B00; font-size: 18px">
        ...
        @foreach ($list_khoa as $khoa )
          @if ($khoa->ma_k == $ma_k)
          <span class="badge text-bg-danger">{{ $khoa->ten_k }}</span>
          @endif
        @endforeach
      </p>
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_hoanthanh_11 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_11_pdf/'.$ma_l.'/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_11_excel/'.$ma_l.'/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_hoanthanh_13))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_hoanthanh_13 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_13_pdf/'.$batdau_capbang.'/'.$ketthuc_capbang.'/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_13_excel/'.$batdau_capbang.'/'.$ketthuc_capbang.'/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_hoanthanh_14))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_hoanthanh_14 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_14_pdf/'.$batdau_capbang.'/'.$ketthuc_capbang.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_14_excel/'.$batdau_capbang.'/'.$ketthuc_capbang.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_hoanthanh_15))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_hoanthanh_15 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_15_pdf/'.$batdau_venuoc.'/'.$ketthuc_venuoc.'/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_15_excel/'.$batdau_venuoc.'/'.$ketthuc_venuoc.'/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_hoanthanh_16))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_hoanthanh_16 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_16_pdf/'.$batdau_venuoc.'/'.$ketthuc_venuoc.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_16_excel/'.$batdau_venuoc.'/'.$ketthuc_venuoc.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_hoanthanh_17))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_hoanthanh_17 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_17_pdf/'.$ma_k.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_hoanthanh_loc_17_excel/'.$ma_k.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_giahan_all))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_all_excel/'.$ma_k.'/'.$ma_l.'/'.$batdau_giahan.'/'.$ketthuc_giahan) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_giahan_2))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_2_excel/'.$ma_l.'/'.$batdau_giahan.'/'.$ketthuc_giahan) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_giahan_3))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_3_excel/'.$ma_k.'/'.$batdau_giahan.'/'.$ketthuc_giahan) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_giahan_4))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_4_excel/'.$ma_k.'/'.$ma_l) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_giahan_5))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_5_excel/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_giahan_6))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_6_excel/'.$ma_l) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_giahan_7))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_7_excel/'.$batdau_giahan.'/'.$ketthuc_giahan) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_giahan_8))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_giahan_8 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_8_pdf/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_8_excel/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_giahan_9))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_giahan_9 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_9_pdf/'.$ma_k.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_9_excel/'.$ma_k.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_giahan_11))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_giahan_11 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_11_pdf/'.$batdau_giahan.'/'.$ketthuc_giahan.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_giahan_loc_11_excel/'.$batdau_giahan.'/'.$ketthuc_giahan.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_dunghoc_all))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_dunghoc_loc_all_excel/'.$ma_k.'/'.$ma_l.'/'.$batdau_dunghoc.'/'.$ketthuc_dunghoc) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_dunghoc_3))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_dunghoc_loc_3_excel/'.$ma_k.'/'.$batdau_dunghoc.'/'.$ketthuc_dunghoc) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_dunghoc_4))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_dunghoc_loc_4_excel/'.$ma_k.'/'.$ma_l) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_dunghoc_5))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_dunghoc_loc_5_excel/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_dunghoc_6))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_dunghoc_loc_6_excel/'.$ma_l) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_dunghoc_7))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_dunghoc_loc_7_excel/'.$batdau_dunghoc.'/'.$ketthuc_dunghoc) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_dunghoc_8))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_dunghoc_8 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_dunghoc_loc_8_pdf/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_dunghoc_loc_8_excel/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_dunghoc_11))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_dunghoc_11 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_dunghoc_loc_11_pdf/'.$ma_qg.'/'.$batdau_dunghoc.'/'.$ketthuc_dunghoc) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_dunghoc_loc_11_excel/'.$ma_qg.'/'.$batdau_dunghoc.'/'.$ketthuc_dunghoc) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_chuyen_2))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_chuyen_loc_2_excel/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_chuyen_3))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_chuyen_loc_3_excel/'.$ma_l) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_chuyen_4))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_chuyen_4 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_chuyen_loc_4_pdf/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_chuyen_loc_4_excel/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_chuyen_5))
      ...
      <table class="table" id="mytable">
        ...
        <tbody  >
          @foreach($list_chuyen_5 as $key => $vc)
            <tr>
              <td>{{ $key+1 }}</td>
              <td>
                <div class="row ">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_chuyen_loc_5_pdf/'.$ma_k.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_do" style=" width: 100%;">
              <i class="fa-solid fa-file-pdf text-light"></i>
              &ensp;
              Xuất file PDF
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_chuyen_loc_5_excel/'.$ma_k.'/'.$ma_qg) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_thoihoc_2))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_thoihoc_loc_2_excel/'.$ma_l.'/'.$batdau_thoihoc.'/'.$ketthuc_thoihoc) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_thoihoc_3))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_thoihoc_loc_3_excel/'.$ma_k.'/'.$batdau_thoihoc.'/'.$ketthuc_thoihoc) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_thoihoc_4))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_thoihoc_loc_4_excel/'.$ma_k.'/'.$ma_l) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_thoihoc_5))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_thoihoc_loc_5_excel/'.$ma_k) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_thoihoc_6))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_thoihoc_loc_6_excel/'.$ma_l) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    @if (isset($list_thoihoc_7))
      ...
      <div class="row">
        ...
        <div class="col-2">
          <a href="{{ URL::to('/thongke_qlcttc_thoihoc_loc_7_excel/'.$batdau_thoihoc.'/'.$ketthuc_thoihoc) }}">
            <button type="button" class="btn btn-warning button_xanhla" style="width: 100%;">
              <i class="fa-solid fa-file-excel text-light"></i>
              &ensp;
              Xuất file Excel
    ...
    new Morris.Bar({
      ...
      data: [
        <?php
          ...
          }else if(isset($count_hoanthanh_8) ){
            foreach ($count_hoanthanh_8 as $key => $count){
              foreach($list_khoa as $key => $khoa){
          ...
          }else if(isset($count_hoanthanh_9) ){
            foreach ($count_hoanthanh_9 as $key => $count){
              foreach($list_quocgia as $key => $quocgia){
                if($count->ma_qg == $quocgia->ma_qg){
          ...
          }else if(isset($count_hoanthanh_11) ){
            foreach ($count_hoanthanh_11 as $key => $count){
              foreach($list_lop as $key => $lop){
                if($count->ma_l == $lop->ma_l){
                  $ten_l = $lop->ten_l;
                  $tong = $count->sum;
          ...
          }else if(isset($count_hoanthanh_13) ){
            foreach ($count_hoanthanh_13 as $key => $count){
              $ngaycapbang_kq = $count->ngaycapbang_kq;
              $tong = $count->sum;
              echo "{ year: '$ngaycapbang_kq', value: $tong },";
            }
          }else if(isset($count_hoanthanh_14) ){
            foreach ($count_hoanthanh_14 as $key => $count){
              foreach($list_quocgia as $key => $quocgia){
                if($count->ma_qg == $quocgia->ma_qg){
                  $ten_qg = $quocgia->ten_qg;
                  $tong = $count->sum;
          ...
          }else if(isset($count_hoanthanh_15) ){
            foreach ($count_hoanthanh_15 as $key => $count){
              $ngayvenuoc_kq = $count->ngayvenuoc_kq;
              $tong = $count->sum;
              echo "{ year: '$ngayvenuoc_kq', value: $tong },";
            }
          }else if(isset($count_hoanthanh_16) ){
            foreach ($count_hoanthanh_16 as $key => $count){
              $ngayvenuoc_kq = $count->ngayvenuoc_kq;
              $tong = $count->sum;
              echo "{ year: '$ngayvenuoc_kq', value: $tong },";
            }
          }else if(isset($count_hoanthanh_17) ){
            foreach ($count_hoanthanh_17 as $key => $count){
              foreach($list_khoa as $key => $khoa){
                if($count->ma_k == $khoa->ma_k){
                  $ten_k = $khoa->ten_k;
                  $tong = $count->sum;
          ...
          }else if(isset($count_giahan_8) ){
            foreach ($count_giahan_8 as $key => $count){
              foreach($list_quocgia as $key => $quocgia){
                  if( $count->ma_qg == $quocgia->ma_qg){
                    $ten_qg = $quocgia->ten_qg;
                    $tong = $count->sum;
          ...
          }else if(isset($count_giahan_9) ){
            foreach ($count_giahan_9 as $key => $count){
              foreach($list_quocgia as $key => $quocgia){
                foreach($list_khoa as $key => $khoa){
          ...
          }else if(isset($count_giahan_11) ){
            foreach ($count_giahan_11 as $key => $count){
              $thoigian_gh = $count->thoigian_gh;
              $tong = $count->sum;
              echo "{ year: '$thoigian_gh', value: $tong },";
            }
          ...
          }else if(isset($count_dunghoc_8) ){
            foreach ($count_dunghoc_8 as $key => $count){
              foreach($list_quocgia as $key => $quocgia){
                  if( $count->ma_qg == $quocgia->ma_qg){
                    $ten_qg = $quocgia->ten_qg;
                    $tong = $count->sum;
          ...
          }else if(isset($count_dunghoc_11) ){
            foreach ($count_dunghoc_11 as $key => $count){
              foreach($list_quocgia as $key => $quocgia){
                if($count->ma_qg == $quocgia->ma_qg){
                  $ten_qg = $quocgia->ten_qg;
                  $tong = $count->sum;
                  $batdau_dh = $count->batdau_dh;
                  echo "{ year: '$ten_qg ($batdau_dh)', value: $tong },";
                }
              }
            }
          ...
          }else if(isset($count_chuyen_4) ){
            foreach ($count_chuyen_4 as $key => $count){
              foreach($list_quocgia as $key => $quocgia){
                if($count->ma_qg == $quocgia->ma_qg){
                  $ten_qg = $quocgia->ten_qg;
                  $tong = $count->sum;
          ...
          }else if(isset($count_chuyen_5) ){
            foreach ($count_chuyen_5 as $key => $count){
              foreach($list_quocgia as $key => $quocgia){
                foreach($list_khoa as $key => $khoa){
                  if($count->ma_qg == $quocgia->ma_qg && $count->ma_k == $khoa->ma_k){
                    $ten_qg = $quocgia->ten_qg;
