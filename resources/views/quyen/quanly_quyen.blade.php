...
<div class="row">
  <div class="card-box">
    ...
    <?php 
      $mess = session()->get('message_add_quyen');
      if ($mess != null) {
        ?>
        ...
        <?php
        $mess = session()->put('message_add_quyen', null);
      }
    ?>
    <?php 
      $mess = session()->get('message_update_quyen');
      if ($mess != null) {
        ?>
        ...
        <?php
        $mess = session()->put('message_update_quyen', null);
      }
    ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="was-validated">
                            <input type='text' id="ten_q" class='form-control input_table' autofocus required name="ten_q" minlength="5">
