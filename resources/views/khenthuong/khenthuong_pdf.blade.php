...
<body>
  <div class="row">
    ...
    <p class="text-center">V/v khen thưởng viên chức</p>
    <p>
      <i>
    ...
    @foreach($khenthuong as $key => $kt)
      <p>
        ...
        Nay tặng {{ $kt->ten_htkt }} cho <b>{{ $kt->hoten_vc }}</b> thuộc khoa {{ $kt->ten_k }} đang công tác tại Trường Công Nghệ Thông Tin Và Truyền Thông - Đại Học Cần Thơ đã đạt thành tích {{ $kt->ten_lkt }}.
      </p>
      <p>
